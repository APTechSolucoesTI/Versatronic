...
class ProdutoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $unidade_medida_id = new TDBCombo('unidade_medida_id', 'minicrm', 'UnidadeMedida', 'id', '{nome}','nome asc' , $criteria_unidade_medida_id );
        ...
        $row3 = $bcontainer_62463e0849f16->addFields([new TLabel("Cod barras:", null, '14px', null, '100%'),$cod_barras],[new TLabel("Ativo:", null, '14px', null, '100%'),$ativo]);
        ...
        $row8 = $this->form->addFields([new TLabel("Preco custo:", null, '14px', null, '100%'),$preco_custo],[new TLabel("Preco venda:", null, '14px', null, '100%'),$preco_venda]);
        ...
        $row12 = $this->form->addFields([new TLabel("Peso liquido:", null, '14px', null, '100%'),$peso_liquido],[new TLabel("Peso bruto:", null, '14px', null, '100%'),$peso_bruto]);
        $row12->layout = ['col-sm-6','col-sm-6'];

        $row13 = $this->form->addContent([new TFormSeparator("Estoque", '#333', '18', '#eee')]);
        $row14 = $this->form->addFields([new TLabel("Qtde estoque:", null, '14px', null, '100%'),$qtde_estoque],[new TLabel("Estoque minimo:", null, '14px', null, '100%'),$estoque_minimo],[new TLabel("Estoque maximo:", null, '14px', null, '100%'),$estoque_maximo]);
