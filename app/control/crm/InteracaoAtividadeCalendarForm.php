...
class InteracaoAtividadeCalendarForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $estado_atividade_id->addValidation("Estado é obrigatório", new TRequiredValidator()); 
        ...
        $row3 = $this->form->addFields([new TLabel("Horário inicial:", null, '14px', null, '100%'),$horario_inicial],[new TLabel("Horário final:", null, '14px', null, '100%'),$horario_final]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('InteracaoTimeline', 'onReload', $paramTimeline);
    ...
    public function onDelete($param = null) 
    {
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                var_dump($object->estado_atividade_id);
                var_dump( EstadoAtividade::CONCLUIDO);
                $interacaoHistoricoAtividade = new InteracaoHistoricoAtividade;
                $interacaoHistoricoAtividade->interacao_id = $object->interacao_id;
                $interacaoHistoricoAtividade->dt_atividade = date('Y-m-d H:i:s');
                $interacaoHistoricoAtividade->descricao = $object->descricao;
