...
class InteracaoItemHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_InteracaoItem';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit = new TDataGridAction(array('InteracaoItemForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('InteracaoItemHeaderList', 'onDelete'));
        ...
        $button_cadastrar->setAction(new TAction(['InteracaoItemForm', 'onShow']), "Cadastrar");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["CRM","Itens da Interação"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new InteracaoItem($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for InteracaoItem
