...
class InteracaoObservacaoHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_InteracaoObservacao';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit = new TDataGridAction(array('InteracaoObservacaoForm', 'onEdit'));
        $action_onEdit->setUseButton(false);
        $action_onEdit->setButtonClass('btn btn-default btn-sm');
        $action_onEdit->setLabel("Editar");
        $action_onEdit->setImage('far:edit #478fca');
        $action_onEdit->setField(self::$primaryKey);
        $action_onEdit->setDisplayCondition('InteracaoObservacaoHeaderList::canEdit');

        $this->datagrid->addAction($action_onEdit);

        $action_onDelete = new TDataGridAction(array('InteracaoObservacaoHeaderList', 'onDelete'));
        $action_onDelete->setUseButton(false);
        $action_onDelete->setButtonClass('btn btn-default btn-sm');
        $action_onDelete->setLabel("Excluir");
        $action_onDelete->setImage('fas:trash-alt #dd5a43');
        $action_onDelete->setField(self::$primaryKey);
        $action_onDelete->setDisplayCondition('InteracaoObservacaoHeaderList::canExcluir');
        ...
        $cadastrar->setAction(new TAction(['InteracaoObservacaoForm', 'onShow']), "Cadastrar");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["CRM","Observações da Interação"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new InteracaoObservacao($key, FALSE); 
                ...
                $interacaoHistoricoObservacao->movimentacao_id = Movimentacao::EXCLUIDO;
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for InteracaoObservacao
    ...
    public static function manageRow($id, $param = [])
    {
        ...
        $object = new InteracaoObservacao($id);
