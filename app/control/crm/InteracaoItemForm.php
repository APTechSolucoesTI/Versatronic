...
class InteracaoItemForm extends TPage
{
    protected BootstrapFormBuilder $form;
    private $formFields = [];
    private static $database = 'minicrm';
    private static $activeRecord = 'InteracaoItem';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de item de Interação");

        $criteria_produto_tipo_produto_id = new TCriteria();

        $id = new TEntry('id');
        $interacao_id = new THidden('interacao_id');
        $produto_tipo_produto_id = new TDBCombo('produto_tipo_produto_id', 'minicrm', 'TipoProduto', 'id', '{nome}','nome asc' , $criteria_produto_tipo_produto_id );
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['InteracaoItemHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public static function onChangeproduto_tipo_produto_id($param)
    {
        try
        {
            ...
            { 
                ...
                TDBCombo::reloadFromModel(self::$formName, 'produto_id', 'minicrm', 'Produto', 'id', '{nome}', 'nome asc', $criteria, TRUE); 
            } 
            else 
            { 
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new InteracaoItem(); // create an empty object 
            ...
            TApplication::loadPage('InteracaoItemHeaderList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new InteracaoItem($key); // instantiates the Active Record 
