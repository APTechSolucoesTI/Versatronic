...
class EtapaInteracaoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de etapa de interação");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['EtapaInteracaoHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new EtapaInteracao(); // create an empty object 
            ...
            TApplication::loadPage('EtapaInteracaoHeaderList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new EtapaInteracao($key); // instantiates the Active Record 
