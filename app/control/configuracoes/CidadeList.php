...
class CidadeList extends TPage
{
    ...
    private static $formName = 'form_CidadeList';
    ...
    public function __construct($param = null)
    {
        ...
        $column_cod_municipio = new TDataGridColumn('cod_municipio', "Cod municipio", 'left');
        ...
        $button_sincronizar->setAction(new TAction(['CidadeList', 'onSincronizar']), "Sincronizar");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['CidadeList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['CidadeList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atualizar->setAction(new TAction(['CidadeList', 'onRefresh']), "Atualizar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['CidadeList', 'onExportCsv'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['CidadeList', 'onExportXls'],['static' => 1]), 'datagrid_'.self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['CidadeList', 'onExportPdf'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['CidadeList', 'onExportXml'],['static' => 1]), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'CidadeListSearch');
            $page->setProperty('page_name', 'CidadeListSearch');
