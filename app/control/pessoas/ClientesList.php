...
class ClientesList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $idUser = Representante::where('system_user_id','=', TSession::getValue("userid"))->first();
        if (!empty($idUser)) {
        ...
        $cidade_id = new TDBCombo('cidade_id', 'minicrm', 'Cidade', 'id', '{nome}  / {estado->sigla}','nome asc' , $criteria_cidade_id );
        ...
        $column_estado_transformed = new TDataGridColumn('estado', "Estado", 'left');
        ...
        $column_cidade_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {
            if (empty($value))
            {
                return '';
        ...
        $column_estado_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {
            if (empty($value))
            {
                return '';
        ...
        $this->datagrid->addColumn($column_estado_transformed);
        ...
        $action_onExcluir = new TDataGridAction(array('ClientesList', 'onExcluir'));
        ...
        $action_onExcluir->setDisplayCondition('ClientesList::canExcluir');
        ...
        $button_sincronizar->setAction(new TAction(['ClientesList', 'onSincronizar']), "Sincronizar");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['ClientesList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['ClientesList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atualizar->setAction(new TAction(['ClientesList', 'onRefresh']), "Atualizar");
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        ...
        if (!in_array($userId, $usuariosQueVeemTudo)) {
            ...
            $page->setProperty('page-name', 'ClientesListSearch');
            $page->setProperty('page_name', 'ClientesListSearch');
