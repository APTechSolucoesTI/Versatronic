...
class ClienteSeekWindow extends TWindow
{
    ...
    public function __construct($param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Nome:", null, '14px', null, '100%'),$razao_social],[new TLabel("Documento:", null, '14px', null, '100%'),$cpf_cnpj],[new TLabel("Email:", null, '14px', null, '100%'),$email]);
        ...
        $column_razao_social = new TDataGridColumn('razao_social', "Nome", 'left');
        $column_cpf_cnpj = new TDataGridColumn('cpf_cnpj', "Documento", 'left');
