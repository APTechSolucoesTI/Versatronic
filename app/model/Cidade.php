...
class Cidade extends TRecord
{
    ...
    public function set_transportadora_cidade_to_string($transportadora_cidade_to_string)
    {
        if(is_array($transportadora_cidade_to_string))
        {
            $values = Cidade::where('id', 'in', $transportadora_cidade_to_string)->getIndexedArray('nome', 'nome');
            $this->transportadora_cidade_to_string = implode(', ', $values);
        }
        else
        {
            $this->transportadora_cidade_to_string = $transportadora_cidade_to_string;
        }

        $this->vdata['transportadora_cidade_to_string'] = $this->transportadora_cidade_to_string;
    }

    public function get_transportadora_cidade_to_string()
    {
        if(!empty($this->transportadora_cidade_to_string))
        {
            return $this->transportadora_cidade_to_string;
        }
    
        $values = Transportadora::where('cidade_id', '=', $this->id)->getIndexedArray('cidade_id','{cidade->nome}');
    ...
    public function get_pessoa_endereco_pessoa_to_string()
    {
        ...
        $values = PessoaEndereco::where('cidade_id', '=', $this->id)->getIndexedArray('pessoa_id','{pessoa->razao_social}');
        return implode(', ', $values);
    }
