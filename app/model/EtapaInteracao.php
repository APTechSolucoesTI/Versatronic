...
class EtapaInteracao extends TRecord
{
    const TABLENAME  = 'etapa_interacao';
    const PRIMARYKEY = 'id';
    ...
    public function getInteracaos()
    {
        ...
        $criteria->add(new TFilter('etapa_interacao_id', '=', $this->id));
    ...
    public function get_interacao_tipo_interacao_to_string()
    {
        ...
        $values = Interacao::where('etapa_interacao_id', '=', $this->id)->getIndexedArray('tipo_interacao_id','{tipo_interacao->nome}');
    ...
    public function get_interacao_cliente_to_string()
    {
        ...
        $values = Interacao::where('etapa_interacao_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->razao_social}');
        return implode(', ', $values);
    }
    ...
    public function get_interacao_vendedor_to_string()
    {
        ...
        $values = Interacao::where('etapa_interacao_id', '=', $this->id)->getIndexedArray('vendedor_id','{vendedor->razao_social}');
        return implode(', ', $values);
    }
    ...
    public function get_interacao_origem_contato_to_string()
    {
        ...
        $values = Interacao::where('etapa_interacao_id', '=', $this->id)->getIndexedArray('origem_contato_id','{origem_contato->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_interacao_etapa_interacao_to_string()
    {
        ...
        $values = Interacao::where('etapa_interacao_id', '=', $this->id)->getIndexedArray('etapa_interacao_id','{etapa_interacao->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_interacao_historico_etapa_interacao_to_string()
    {
        ...
        $values = InteracaoHistoricoEtapa::where('etapa_interacao_id', '=', $this->id)->getIndexedArray('interacao_id','{interacao->id}');
        return implode(', ', $values);
    }
    ...
    public function get_interacao_historico_etapa_etapa_interacao_to_string()
    {
        ...
        $values = InteracaoHistoricoEtapa::where('etapa_interacao_id', '=', $this->id)->getIndexedArray('etapa_interacao_id','{etapa_interacao->nome}');
        return implode(', ', $values);
    }
