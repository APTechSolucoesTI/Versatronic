...
FOREIGN KEY(nota_baixada_id) REFERENCES nota_baixada(id)) ; 
...
CREATE TABLE interacao_atividade_revisao( 
      ...
      created_at datetime   , 
 PRIMARY KEY (id),
FOREIGN KEY(interacao_atividade_id) REFERENCES interacao_atividade(id),
FOREIGN KEY(system_users_id) REFERENCES system_users(id)) ; 
...
CREATE TABLE prazo_atividade( 
      ...
      deleted_at datetime   , 
 PRIMARY KEY (id),
FOREIGN KEY(regras_tipo_atividade_id) REFERENCES regras_tipo_atividade(id),
FOREIGN KEY(categoria_cliente_id) REFERENCES categoria_cliente(id)) ; 
