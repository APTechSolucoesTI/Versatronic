...
FROM interacao_localizacao;; 
 ...
 CREATE index idx_centro_custo_nota_centro_custo_id on centro_custo_nota(centro_custo_id); 
CREATE index idx_centro_custo_nota_nota_baixada_id on centro_custo_nota(nota_baixada_id); 
CREATE index idx_cidade_estado_id on cidade(estado_id); 
CREATE index idx_comissao_repres_representante_id on comissao_repres(representante_id); 
CREATE index idx_comissao_repres_excecao_representante_id on comissao_repres_excecao(representante_id); 
CREATE index idx_comissao_repres_excecao_pessoa_id on comissao_repres_excecao(pessoa_id); 
...
CREATE index idx_configuracao_email_system_users_id on configuracao_email(system_users_id); 
CREATE index idx_controle_nota_nota_baixada_id on controle_nota(nota_baixada_id); 
...
CREATE index idx_interacao_atividade_revisao_interacao_atividade_id on interacao_atividade_revisao(interacao_atividade_id); 
CREATE index idx_interacao_atividade_revisao_system_users_id on interacao_atividade_revisao(system_users_id); 
...
CREATE index idx_nota_baixada_teste_nota_status_id on nota_baixada_teste(nota_status_id); 
CREATE index idx_nota_baixada_teste_coligada_id on nota_baixada_teste(coligada_id); 
...
CREATE index idx_prazo_atividade_regras_tipo_atividade_id on prazo_atividade(regras_tipo_atividade_id); 
CREATE index idx_prazo_atividade_categoria_cliente_id on prazo_atividade(categoria_cliente_id); 
...
CREATE index idx_tipo_atividade_regras_tipo_atividade_id on tipo_atividade(regras_tipo_atividade_id); 
